...
OutFile "build\GTAIV_V2_Automatic_Installer_v2.0.1.exe"
InstallDir "$PROGRAMFILES\Rockstar Games\GTA IV"
InstallDirRegKey HKLM "Software\Rockstar Games\Grand Theft Auto IV" "InstallFolder"
...
Function .onVerifyInstDir
  ...
  MessageBox MB_ICONSTOP "Select the GTA IV installation folder that contains GTAIV.EXE."
  Abort
validGame:
FunctionEnd
...
Function SetRunAsAdmin
  ...
  ; Uninstall restores the recorded prior value when one existed.
