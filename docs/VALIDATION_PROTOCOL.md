# Version 3.0.4 Validation Protocol

Version 3.0.4 deliberately does **not** claim a new independently reproduced performance result. This document defines the minimum evidence required before calling any renderer or quality profile “tested,” “log-validated,” or suitable for another hardware class.
