# GTA IV Radeon 660M Reference Context — Version 3.0.5

> **Status:** This is a hardware-context document, not an independently reproduced benchmark report. Version 3.0.5 does not publish frame-time captures or a retained renderer log for the stated reference machine.
